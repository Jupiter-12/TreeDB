...
const PROJECT_ROOT = path.join(__dirname, '..');  // 项目根目录
const STATIC_ROOT = path.join(PROJECT_ROOT, 'public');  // 静态文件目录
const DB_PATH = process.env.DB_PATH || path.join(PROJECT_ROOT, 'data', 'databases', 'treedb.sqlite');  // 数据库放在 data 目录，避免污染项目根
